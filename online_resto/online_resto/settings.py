"""
Django settings for online_resto project.
...
SECRET_KEY = 'django-insecure-)l65epuqj2=%y6x-4k*b4xi7a&rm$hw9@t$$e3v%apgz0n(mm-'
...
ROOT_URLCONF = 'online_resto.urls'
...
WSGI_APPLICATION = 'online_resto.wsgi.application'
